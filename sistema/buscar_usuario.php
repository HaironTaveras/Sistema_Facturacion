...
<body>
	...
	<section id="container">
		...
		<a href="registro_usuario.php" class="btn_new"><i class="fas fa-user-plus"></i> Registrar Usuario</a> 

		<form action="buscar_usuario.php" method="get" class="formulario_buscar"> 
			...
			?>
		  	 ...
		  	 <tr>
				...
				<td>
					...
					|
					<a class="link_delete" href="eliminar_confirmar_usuario.php?id=<?php echo $data['idusuario'];?>"><i class="fas fa-user-times"></i> Desactivar </a>
